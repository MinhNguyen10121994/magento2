...
class InitParamListener implements ListenerAggregateInterface, FactoryInterface
{
     ...
     * @inheritdoc
     *
     * The $priority argument is added to support latest versions of Laminas Observer Manager.
     * Starting from Laminas Observer Manager 3.0.0 release the ListenerAggregateInterface::attach()
