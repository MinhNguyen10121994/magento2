...
namespace MinhNB\Jobs\Block\Adminhtml\Product\Attribute;
 ...
 * @since 100.0.2
 */
class Department extends \Magento\Backend\Block\Template
{
    /**
     ...
     * @var string
     */
    protected $_template = 'MinhNB_Jobs::product/attribute.phtml';
